const treasuryImplementations = require("../../models/Practice/treasuryImplementations");
const azureBlobService = require("../../services/azureBlobService");

// Fetch the Technology Section
exports.gettreasuryImplementations = async (req, res) => {
  try {
    let section = await treasuryImplementations.findOne();

    // If no section exists, create a default one
    if (!section) {
      section = await treasuryImplementations.create({
...
exports.upserttreasuryImplementations = async (req, res) => {
  try {
    ...
    const existingSection = await treasuryImplementations.findOne();
    ...
    const section = await treasuryImplementations.findOneAndUpdate({}, updateData, { new: true, upsert: true });
...
exports.addCard = async (req, res) => {
  try {
    ...
    const section = await treasuryImplementations.findOne();
    if (!section) {
